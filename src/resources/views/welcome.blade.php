...
<head>
    ...
    <meta content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0,user-scalable=no"
        name=viewport>
    <title> Fuera de servicio | Pagina en mantenimiento  </title>
...
<body>
    ...
    <div class=message> 
        <div class=message__title> Fuera de servicio por mantenimiento </div>
        <p> Esta aplicación está en mantenimiento en este momento. </p>
